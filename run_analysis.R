...
subject_train <- read.table("~/Desktop/Coursera/UCI HAR Dataset/train/subject_train.txt", 
                            sep = '\n', col.names = "subject")
X_train <- read.table("~/Desktop/Coursera/UCI HAR Dataset/train/X_train.txt", sep = '\t', col.names = "X")
Y_train <- read.table("~/Desktop/Coursera/UCI HAR Dataset/train/y_train.txt", sep = '\n', col.names = "Y")


###### Test Data #########
subject_test <- read.table("~/Desktop/Coursera/UCI HAR Dataset/test/subject_test.txt",
                           sep = '\n', col.names = "subject")
X_test <- read.table("~/Desktop/Coursera/UCI HAR Dataset/test/X_test.txt", sep = '\t', col.names = "X")
Y_test <- read.table("~/Desktop/Coursera/UCI HAR Dataset/test/y_test.txt", sep = '\n', col.names = "Y")


# Loading the text file containing features list
features <- read.table("~/Desktop/Coursera/UCI HAR Dataset/features.txt", sep = '\n', col.names = "Features")
...
activity_labels <- read.table("~/Desktop/Coursera/UCI HAR Dataset/activity_labels.txt",
...
write.table(tidy_data, "~/Desktop/Coursera/DataScience/Course3_Project/tidy_data.txt")
